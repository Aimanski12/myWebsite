...
export default function sendEmail  (name, email, subject, mes) {
    ...
    Email.send({
      ...
      Body: `
        ...
        <h3>Hello ${name},</h3>
        <p>Thank you for so much for reaching out to me. It fascinates me so much to be involved with great and amazing people like you.</p>
        ...
        <p>Once again, thank you so much for your message and have a good day ahead.</p>
        </br>
        <p>Cheers!</p>
